...
@REM ks-7.9、ks-7.9_avgpool3、ks-7.9_avgpool7、ks-7.9_maxpool3、ks-7.9_maxpool7、ks-7.9_conv1x1
set name=ks-7.9_avgpool3
set input_folder=data/train/gm12878_ctcf
set out_folder=output/gm12878_ctcf/2024.08.20_cnn_hyper-test-%name%_1000bp
set config_folder=conf/MCIENet_bt
