...
@REM ks7.9-cr2.4.4、ksks3.5.7.9-cr2.4.4、ks7.9-cr2.6.2、ksks3.5.7.9-cr2.6.2

set name=ks7.9-cr2.4.4-maxpool3
...
@REM hyper
set "classifier_hidden_layer=2, 3"
set "classifier_hidden_size=100, 200, 300"

set "extractor_total_channels=200, 400, 600, 800"

set "classifier_dropout=0.5"
set "extractor_dropout=0.3, 0.5"
