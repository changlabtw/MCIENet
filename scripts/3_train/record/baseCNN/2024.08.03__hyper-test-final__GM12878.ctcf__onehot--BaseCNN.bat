...
set out_folder=output/gm12878_ctcf/2024.08.03_cnn_hyper-test-final_1000bp
...
@REM hyper
set "extractor_hidden_size=10, 50, 100, 200, 300"

@REM set "classifier_dropout=0.0, 0.5"
set "classifier_dropout=0.5" 
@REM set "classifier_hidden_layer=1, 2, 3, 5"
set "classifier_hidden_layer=3, 5"

set "classifier_hidden_size=10, 50, 100, 200, 300"
