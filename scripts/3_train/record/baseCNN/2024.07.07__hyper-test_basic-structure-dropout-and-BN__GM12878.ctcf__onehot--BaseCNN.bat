...
set out_folder=output/gm12878_ctcf/2024.07.07_cnn_hyper-test-basic-structure
...
set "extractor_dropout=0.0, 0.3, 0.5"
set "classifier_dropout=0.0, 0.3, 0.5"

set "extractor_bn=True, False"
set "classifier_bn=True, False"
