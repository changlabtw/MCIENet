set in_folder=data/proc/gm12878_ctcf
set out_folder=data/train/gm12878_ctcf

python data_helper.py -m onehot -s 3000 --min_size 50 ^
                      ...
                      -o %out_folder%/3000bp.50ms.onehot
