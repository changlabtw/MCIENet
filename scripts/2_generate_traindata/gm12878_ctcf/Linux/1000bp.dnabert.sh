...
# directly using dnabert pretrain model to generate Feature vector as input
# the result of this method is worse than using onehot encoding, not used in benchmark
...
# train 9.80it/s 237888 大約 6:44:35
# val 10.34it/s 27762 大約 44:44 
# test 10.06it/s 58836 大約 1:37:28  
# 共 324486 筆， 9:6:47
